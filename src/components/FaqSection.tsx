      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-500 max-w-xl mx-auto text-base">
            Temukan jawaban atas pertanyaan yang sering diajukan seputar paket umrah kami.
          </p>
        </div>
        ...
        <div className="text-center mt-12">
          ...
          <a
            href="https://wa.me/6281234567890?text=Assalamualaikum%2C%20saya%20punya%20pertanyaan%20seputar%20umrah"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-full font-semibold transition shadow-lg shadow-emerald-200"
          >
